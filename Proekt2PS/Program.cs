...
static class RPGInventory 
{
    ...
    public static void GenerateStructInventory(int count)
    {
        ...
        try
        {
            ...
            Console.WriteLine($"\nStruct Inventory generated with {count:N0} items.");  
        }
        catch (OutOfMemoryException)
        {
            Console.WriteLine($"\nOut of memory trying to allocate {count:N0} struct items!");
    ...
    public static void GenerateClassInventory(int count)
    {
        ...
        {
            Console.WriteLine($"\nOut of memory trying to allocate {count:N0} class items!");
            classInventory = null;
        }
    }
    ...
    public static void ShowStructInventory(int maxItems = 10)
    {
        ...
        {
            Console.WriteLine("\nStruct Inventory is empty! Please generate inventory first (Option 1).");
            return;
        }

        if (maxItems <= 0)
        {
            Console.WriteLine("\nInvalid maxItems value. Showing first 10 items instead.");
            maxItems = 10;
        }
    ...
    public static void ShowClassInventory(int maxItems = 10)
    {
        ...
        {
            Console.WriteLine("\nClass Inventory is empty! Please generate inventory first (Option 2).");
            return;
        }
    ...
    public static void EquipStructItem(int index)
    {
        ...
        {
            Console.WriteLine("\nNo struct inventory generated yet!");
            return;
        }
        ...
        {
            Console.WriteLine($"\nInvalid index! Please enter a number between 1 and {structInventory.Length}.");
        }
    }
    ...
    public static void EquipClassItem(int index)
    {
        ...
        {
            Console.WriteLine("\nNo class inventory generated yet!");
            return;
        }
        ...
        {
            Console.WriteLine($"\nInvalid index! Please enter a number between 1 and {classInventory.Length}.");
        }
    }
    ...
    public static void DropClassItem(int index)
    {
        ...
        if (index >= 0 && index < classInventory.Length)
        {
            if (classInventory[index] == null)
            {
                Console.WriteLine($"\nItem at index {index + 1} is already null!");
                return;
            }
    ...
    public static void RunStructTest(int count)
    {
        ...
        if (structInventory == null)
        {
            Console.WriteLine("Failed to generate struct inventory!");
            return;
        }
    ...
    public static void RunClassTest(int count)
    {
        ...
        if (classInventory == null)
        {
            Console.WriteLine("Failed to generate class inventory!");
            return;
        }
        ...
        Console.WriteLine($"   Note: Class version creates {length:N0} heap objects vs 1 array for structs");
    }
}
    ...
    static void Main()
    {
        ...
        while (true)
        {
            ...
            switch (choice)
            {
                ...
                case "7":
                    Console.Write("Enter item number to drop: ");
